...
function filtrarFacturas(fecha = "", opcion = "") {
  if (opcion == "") {
    paintTable(
      "/facturaemitida/filtrarFactura?fecha=" + fecha,
      [
        "NO FACTURA",
        "VENDEDOR",
        "CLIENTE",
    ...
    paintTable(
      "/facturaemitida/filtrarFacturaEnEspera",
      [
        "NO FACTURA",
        "VENDEDOR",
        "CLIENTE",
...
function edit(id) {
  try {
    ...
    $.get("/factura/getDetallePedidoByIidfactura?id=" + id, function (lst) {
      var html = "";
      html +=
        '<table class="table table-hover table-bordered table-responsive-lg table-responsive-md table-responsive-sm" id = "listProductsFactura">';
