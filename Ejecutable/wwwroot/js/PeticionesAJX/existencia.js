...
function callTable() {
    paintTable('/existencia/listProducto', ['código', 'descripción','stock', 'existencias', 'subexistencia', 'fracciones res.'],
        ['codigoproducto', 'descripcion','nombrestock', 'existencias', 'subexistencia', 'restantes'], 'iidproducto', 'modalEntrada', false, true);
