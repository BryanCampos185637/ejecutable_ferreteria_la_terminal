...
function callTable() {
  paintTable(
    ...
    ["nombre", "edad", "teléfono", "dui"],
    ["nombrecompleto", "edad", "telefono", "dui"],
    "iidempleado",
    "modalEmpleado"
  );
  fillCombo(
    "/empleado/listTipoUsuario",
    "iidtipousuario",
    "nombretipousuario",
    "iidtipousuario",
    "descripcion"
          ...
          if (contraseña1.length >= 5) {
            ...
            if (contraseña1.trim() == contraseña.trim()) {
              ...
              sendDataController(
                ...
                frm,
                "Este DUI ya existe en la base de datos"
              );
            } else {
            ...
            messeges(
              "error",
              "Las contraseñas deben de tener por lo menos 5 caracteres "
            );
          }
        } else {
